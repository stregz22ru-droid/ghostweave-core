# GHOSTWEAVE SDK — Public API Specification
...
This document defines the **Public API Surface** of the GHOSTWEAVE SDK.

The Public API is frozen for SDK v1.0.0. Breaking changes require a new MAJOR version.
...
| `getLastEvent(chain: Chain): Event \| null` | Get the last event |
...
| `getLastHash(chain: Chain): Hash` | Get hash of last event |
